...
while True:
    ...
    #gui
    cv2.putText(frame,'cursor speed={}'.format(speed),(500,10),font,.5,(0,0,0),2)
    cv2.putText(frame,'keep head inside the white square for still cursor',(0,10),font,.5,(0,0,0),2)
